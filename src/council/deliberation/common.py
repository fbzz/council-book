...
def prompt_context(policy: Policy) -> dict[str, Any]:
    ...
    return {
        ...
        "level_up": _fmt_level(float(policy.reference["trend"]["levels"]["up"])),
        "level_mixed": _fmt_level(float(policy.reference["trend"]["levels"]["mixed"])),
        "level_down": _fmt_level(float(policy.reference["trend"]["levels"]["down"])),
        "trend_band_pct": _fmt_level(float(policy.reference["trend"].get("band_pct", 0.0))),
        "max_cards": 8,
        "claim_max": 200,
        "falsifier_max": 160,
        "reason_max": 160,
